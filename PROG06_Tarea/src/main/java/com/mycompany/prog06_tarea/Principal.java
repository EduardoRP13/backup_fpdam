    ...
    public static void main(String[] args) {
        ...
        while (!salir) {
            ...
            try {
                ...
                System.out.println("2. Ver las cuenta disponible.");
                System.out.println("3. Obtener los datos de la cuenta.");
                System.out.println("4. Realizar un ingreso en la cuenta..");
                System.out.println("5. Retirar efectivo de la cuenta.");
                System.out.println("6. Consultar el saldo actual de la cuenta.");
                System.out.println("7. Salir de la aplicación.");
                System.out.println("Elige una opcion de 1 a 6.");
